...
const ITEMS = [
    ...
    { title: "安全中心", description: "权限、角色与审计日志，保护你的业务数据。             *******", href: "/security", thumbnail: "/images/zipdownload.png" },
...
/* 
const ITEMS = [
    { title: "表格v02", description: "工程信息                                          ****", href: "/0915mrt", thumbnail: "/images/logowasu.png", carddate: "2025-09-16更新" },
    ...
    { title: "全局搜索", description: "至2025-157分册 支持多关健字与减号(-) ****高亮匹配与跳转。", href: "/comprehensivesearch", thumbnail: "/images/Internetsearch.png", carddate: "2025-08-28" },
    ...
    { title: "智能工具", description: "代码生成、**********批量操作与自动化流程。                ", href: "/ai-tools", badge: "AI", thumbnail: "/images/zipdownload.jpg" },    
    { title: "安全中心", description: "权限、角色与审计日志，保护你的业务数据。             *******", href: "/security", thumbnail: "/images/zipdownload.jpg" },
    { title: "表格v01", description: "工程信息                                              ****", href: "/0906projects", thumbnail: "/images/logowasu.png", carddate: "2025-09-08更新" },
]; */